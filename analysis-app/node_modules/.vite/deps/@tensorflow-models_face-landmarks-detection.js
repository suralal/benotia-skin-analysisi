        ...
        for (; s; ) try {
          ...
          switch (r = 0, o && (i3 = [2 & i3[0], o.value]), i3[0]) {
            ...
            case 7:
              ...
              continue;
            default:
              if (!(o = s.trys, (o = o.length > 0 && o[o.length - 1]) || 6 !== i3[0] && 2 !== i3[0])) {
                s = 0;
                continue;
              }
...
function B(t, n) {
  ...
  if (t.topLeft instanceof Tensor && t.bottomRight instanceof Tensor) {
    ...
    i = h[0], u = h[1], null != t.landmarks && (c = tidy(function() {
      var r = sub(tensor1d([n - 1, 0]), t.landmarks), o = tensor1d([1, -1]);
      return mul(r, o);
    }));
  } else {
    var l = t.topLeft, d = l[0], p = l[1], m = t.bottomRight, b = m[0], y = m[1];
    i = [n - 1 - d, p], u = [n - 1 - b, y], null != t.landmarks && (c = t.landmarks.map(function(t2) {
      return [n - 1 - t2[0], t2[1]];
    }));
  }
  var g = { topLeft: i, bottomRight: u };
  return null != c && (g.landmarks = c), null != t.probability && (g.probability = t.probability instanceof Tensor ? t.probability.clone() : t.probability), g;
}
function C(t, e) {
...
var O = function() {
  function v(n, r, o, i, s, a) {
    this.blazeFaceModel = n, this.width = r, this.height = o, this.maxFaces = i, this.anchorsData = function(t, e, n2) {
      for (var r2 = [], o2 = 0; o2 < n2.strides.length; o2++) for (var i2 = n2.strides[o2], s2 = Math.floor((e + i2 - 1) / i2), a2 = Math.floor((t + i2 - 1) / i2), u = n2.anchors[o2], c = 0; c < s2; c++) for (var h = i2 * (c + 0.5), l = 0; l < a2; l++) for (var f = i2 * (l + 0.5), d = 0; d < u; d++) r2.push([f, h]);
      return r2;
  ...
  return v.prototype.getBoundingBoxes = function(e, d, p) {
    return void 0 === p && (p = true), k(this, void 0, void 0, function() {
        ...
        switch (U2.label) {
          ...
          case 3:
            for (I2 = e.shape[1], B2 = e.shape[2], C2 = d ? div([B2, I2], this.inputSize) : [B2 / this.inputSizeData[0], I2 / this.inputSizeData[1]], O2 = [], R2 = function(e2) {
              ...
              O2.push(i);
            }, T2 = 0; T2 < E2.length; T2++) R2(T2);
            return y.dispose(), g.dispose(), v2.dispose(), [2, { boxes: O2, scaleFactor: C2 }];
        }
      });
    });
  }, v.prototype.estimateFaces = function(t, e, n, i) {
    return void 0 === e && (e = false), void 0 === n && (n = false), void 0 === i && (i = true), k(this, void 0, void 0, function() {
...
function R(t) {
  var e = void 0 === t ? {} : t, n = e.maxFaces, r = void 0 === n ? 10 : n, o = e.inputWidth, i = void 0 === o ? 128 : o, s = e.inputHeight, a = void 0 === s ? 128 : s, u = e.iouThreshold, c = void 0 === u ? 0.3 : u, h = e.scoreThreshold, l = void 0 === h ? 0.75 : h, f = e.modelUrl;
  return k(this, void 0, void 0, function() {
    var t2;
    return L(this, function(e2) {
      switch (e2.label) {
        case 0:
          return null == f ? [3, 2] : [4, loadGraphModel(f)];
        case 1:
...
function Y(t, e, n, r) {
  for (var o = 0; o < X.length; o++) {
    ...
    if (null == r || r.includes(s)) for (var c = 0; c < a.length; c++) {
      var h = a[c];
...
var Z = function() {
  ...
  return e.prototype.transformRawCoords = function(t, e2, n, r) {
    ...
    return e2.map(function(t2, e3) {
      var n2 = i;
      return 2 === e3 ? n2 = r : 4 === e3 && (n2 = o), [t2[0], t2[1], n2];
    });
    ...
    return x(this, void 0, void 0, function() {
      ...
      return E(this, function(f) {
        switch (f.label) {
          ...
          case 1:
            return s = f.sent(), a = s.boxes, c = s.scaleFactor, 0 === a.length ? (this.regionsOfInterest = [], [2, null]) : (h = a.map(function(t) {
          ...
          case 3:
            return [2, tidy(function() {
              return l.regionsOfInterest.map(function(o, s2) {
                ...
                false === c2 && (h2 = K[0], f2 = K[1]), a2 = z(o.landmarks[h2], o.landmarks[f2]);
                var d = U({ startPoint: o.startPoint, endPoint: o.endPoint }), p = [d[0] / e2.shape[2], d[1] / e2.shape[1]], m = e2, y = W;
                0 !== a2 && (m = image.rotateWithOffset(e2, a2, 0, p), y = _(-a2, d));
...
function tt(t) {
  return x(this, void 0, void 0, function() {
    ...
    return E(this, function(b) {
      switch (b.label) {
        case 0:
          return e = t.maxContinuousChecks, n = void 0 === e ? 5 : e, r = t.detectionConfidence, o = void 0 === r ? 0.9 : r, i = t.maxFaces, s = void 0 === i ? 10 : i, a = t.iouThreshold, u = void 0 === a ? 0.3 : a, c = t.scoreThreshold, h = void 0 === c ? 0.75 : c, l = t.shouldLoadIrisModel, f = void 0 === l || l, d = t.modelUrl, p = t.detectorModelUrl, m = t.irisModelUrl, f ? [4, Promise.all([et(p, s, u, h), nt(d), rt(m)])] : [3, 2];
        case 1:
          return v = b.sent(), [3, 4];
        case 2:
  ...
  return t.getAnnotations = function() {
    ...
    return x(this, void 0, void 0, function() {
      ...
      return E(this, function(k2) {
        switch (k2.label) {
          case 0:
            if (n = t2.returnTensors, r = void 0 !== n && n, i = t2.flipHorizontal, s = void 0 !== i && i, a = t2.predictIrises, u = void 0 === a || a, c = t2.input, u && null == this.pipeline.irisModel) throw new Error("The iris model was not loaded as part of facemesh. Please initialize the model with facemesh.load({shouldLoadIrisModel: true}).");
            ...
            }), "webgl" !== getBackend() ? [3, 2] : (P = env().get("WEBGL_PACK_DEPTHWISECONV"), env().set("WEBGL_PACK_DEPTHWISECONV", true), [4, this.pipeline.predict(v, u)]);
          case 1:
          ...
          case 4:
            return v.dispose(), null != b && b.length > 0 ? [2, Promise.all(b.map(function(t3, n2) {
              return x(w2, void 0, void 0, function() {
                ...
                return E(this, function(k3) {
                  switch (k3.label) {
                    ...
                    case 1:
                      if (f = k3.sent(), d = f[0], c2.dispose(), d < this.detectionConfidence && this.pipeline.clearRegionOfInterest(n2), r) return p = { kind: "MediaPipePredictionTensors", faceInViewConfidence: d, mesh: o, scaledMesh: i2, boundingBox: { topLeft: tensor1d(a2.startPoint), bottomRight: tensor1d(a2.endPoint) } }, s ? [2, ot(p, l)] : [2, p];
                      for (P2 in m = f.slice(1), v2 = m[0], b2 = m[1], i2.dispose(), o.dispose(), y = { kind: "MediaPipePredictionValues", faceInViewConfidence: d, boundingBox: { topLeft: a2.startPoint, bottomRight: a2.endPoint }, mesh: v2, scaledMesh: b2 }, s && (y = ot(y, l)), g = {}, T) (u || false === P2.includes("Iris")) && (g[P2] = T[P2].map(function(t4) {
...
function at(t, e) {
  return void 0 === t && (t = it.mediapipeFacemesh), void 0 === e && (e = {}), x(this, void 0, void 0, function() {
